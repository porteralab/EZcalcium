function ez_multiplot2(raw_traces,plots_per_page,filename,frame_length,x_units,x_tick_number,y_units,y_tick_number,open_pdf,roi_numbers,active_traces,baseline,threshold,stimulus)
