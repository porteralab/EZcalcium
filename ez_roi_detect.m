...
if ~isempty(warning_text)
    warning_text = ['It seems like you do not have the following MATLAB toolboxes installed: ' newline warning_text newline newline 'ROI Detection will not work without these toolboxes.'];
